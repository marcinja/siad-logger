...
# Warning: currently logs don't get written write away. As a result, when
# gnuplot scripts try reading the logs, they see nothing and error or create
# blank graphs. TODO: Fix this.
# For now: run the siad-logger.sh separately.
